...
summary_input <- "inst/extdata/Data Sheet Input/S285_Station_Summary_Input.xls"
elg_input <- "inst/extdata/S285_elg/"
csv_output <- "inst/extdata/Data Sheet CSVs/S285_station.csv"
create_summary(summary_input, elg_input, csv_output = csv_output)

# Create CTD datasheet
data_input <- "inst/extdata/Data Sheet Input/S285_CTD_Input.xls"
summary_csv <- "inst/extdata/Data Sheet CSVs/S285_station.csv"
csv_output <- "inst/extdata/Data Sheet CSVs/S285_CTD.csv"
data_type = "CTD"
...
data_input <- "inst/extdata/Data Sheet Input/S285_Neuston_Input.xls"
summary <- "inst/extdata/Data Sheet CSVs/S285_station.csv"
csv_output <- "inst/extdata/Data Sheet CSVs/S285_NT.csv"
elg_input <- "inst/extdata/S285_elg/"
data_type = "NT"
